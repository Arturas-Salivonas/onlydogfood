...
export function Footer() {
  return (
    <footer className="bg-[var(--color-text-primary)] text-[var(--color-background-card)] border-t border-[var(--color-border)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4 group">
              ...
              <span className="text-xl font-bold text-[var(--color-background-card)]">
                OnlyDogFood
              </span>
            </Link>
            ...
            <div className="flex gap-3">
              <a href="https://twitter.com" target="_blank" rel="noopener" className="w-10 h-10 bg-[var(--color-trust-bg)] hover:bg-[var(--color-trust)] text-[var(--color-text-primary)] rounded-lg flex items-center justify-center transition-all">
                <span className="text-lg">𝕏</span>
              </a>
              <a href="https://facebook.com" target="_blank" rel="noopener" className="w-10 h-10 bg-[var(--color-trust-bg)] hover:bg-[var(--color-trust)] text-[var(--color-text-primary)] rounded-lg flex items-center justify-center transition-all">
                <span className="text-lg">f</span>
              </a>
              <a href="https://instagram.com" target="_blank" rel="noopener" className="w-10 h-10 bg-[var(--color-trust-bg)] hover:bg-[var(--color-trust)] text-[var(--color-text-primary)] rounded-lg flex items-center justify-center transition-all">
          ...
          {/* Products */}
          <div>
            <h3 className="text-[var(--color-background-card)] font-bold mb-4 text-sm">Products</h3>
          ...
          {/* Company */}
          <div>
            <h3 className="text-[var(--color-background-card)] font-bold mb-4 text-sm">Company</h3>
            <ul className="space-y-3 text-sm">
              <li>
          ...
          {/* Legal */}
          <div>
            <h3 className="text-[var(--color-background-card)] font-bold mb-4 text-sm">Legal</h3>
            <ul className="space-y-3 text-sm">
              <li>
